      ...
      <div class="col-12">
        <div class="inner-head">
          ...
          <div class="inner-menu-mb">
            ...
            <ul class="menu-mb">
              <li><a href="/home" class="active-menu"><i class="fa-solid fa-house"></i>Trang Chủ</a></li>
      ...
      <div class="row">
        ...
        <div class="col-xl-6 col-12">
          <div class="inner-main">
            ...
            <a th:href="/introduce" class="action btn">Tìm hiểu thêm</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="inner-body" >
      ...
      <div class="row carousel-room-1" >
        <div class="card col-xl-4 col-lg-6 col-12" th:each="post :${posts}">
          <div class="inner-box">
            ...
            <div class="inner-bot">
              ...
              <a th:href="/login" class="btn">Xem Phòng</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-12">
        <div class="text-center">
          <a th:href="/post" class="btn btn-seemore">Xem Thêm</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div class="wrapper">
      <div class="row carousel-comments">
        <div class="card col-xl-4 col-lg-6 col-12" th:each="comment :${comments}">
          <div class="inner-box">
            ...
            <a th:href="/login" class="btn">Xem Bình Luận</a>
          </div>
        </div>
      </div>
      <div class="inner-btn">
