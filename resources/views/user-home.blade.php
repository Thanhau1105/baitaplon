                ...
                <div class="inner-head">
                    ...
                    <div class="inner-menu">
                        <ul class="menu">
                            ...
                            <li><a href="/post/create">Đăng Bài</li>
                        </ul>
                    </div>
    ...
    <div class="container">
        ...
        <div class="inner-body" >
            ...
            <div class="row carousel-room-1" >
                <div class="card col-xl-4 col-lg-6 col-12" each="post: ${posts}">
                    <div class="inner-box">
                        <div class="inner-img" if="${post.listImages != null and !post.listImages.isEmpty()}">
    ...
    <div class="container">
        ...
        <div class="wrapper">
            <div class="row carousel-comments">
                <div class="card col-xl-4 col-lg-6 col-12" each="comment :${comments}">
                    <div class="inner-box">
                        <h2 text="${comment.user.email}"></h2>
                        <div class="comment-rating">
                            <span each="i : ${#numbers.sequence(0, 4)}">
